...
namespace SmartStore.LMS.Models
{
    ...
    public class ConfigurationModel : ModelBase
    {
        ...
        [SmartResourceDisplayName("Plugins.SmartStore.LMS.MyFirstSetting")]
        [AllowHtml]
        ...
        /// </summary>
        [UIHint("Picture")]
        [SmartResourceDisplayName("Plugins.SmartStore.LMS.PictureId")]
        public int PictureId { get; set; }

        /// <summary>
        /// Renders a color picker control onto a string property
        /// </summary>
        [SmartResourceDisplayName("Plugins.SmartStore.LMS.Color")]
        [UIHint("Color")]
        ...
        //[Required]
        [AllowHtml]
        [SmartResourceDisplayName("Plugins.SmartStore.LMS.Text")]
